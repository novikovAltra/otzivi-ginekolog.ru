var OfficeMS2 = function(config) {
	config = config || {};
	OfficeMS2.superclass.constructor.call(this,config);
};
Ext.extend(OfficeMS2,Ext.Component,{
	page:{},window:{},grid:{},tree:{},panel:{},combo:{},config:{},view:{},keymap:{},plugin:{},utils:{}
});

Ext.reg('minishop2',OfficeMS2);
OfficeMS2 = new OfficeMS2();
...
OfficeMS2.utils.formatDate = function(string) {
