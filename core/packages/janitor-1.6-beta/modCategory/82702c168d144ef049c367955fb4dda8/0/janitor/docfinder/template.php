...
<html xmlns="http://www.w3.org/1999/xhtml" <?php echo $dir; ?> lang="<?php echo $lang; ?>" xml:lang="<?php echo $lang; ?>"> 
	<head>
		...
		<?php $finderAssets = $modxConfig['assets_url'] . '/components/janitor/docfinder/'?>
                <base href="<?php echo $finderAssets?>" />
		...
		<script type="text/javascript" src="js/vlaCal.v2/jslib/vlaCal-v2.js"></script>
		<link type="text/css" media="screen" href="js/vlaCal.v2/styles/vlaCal-v2.css" rel="stylesheet" />
		<link type="text/css" media="screen" href="js/vlaCal.v2/styles/vlaCal-v2-apple_widget.css" rel="stylesheet" />
	</head>
	...
	<body>
		<form action="<?php echo htmlentities($_SERVER['REQUEST_URI']); ?>" method="post" target="main" id="docfinder" name="docfinder">
			...
			<div class="sectionBody">
				...
				<?php if($modxConfig['modx_charset']!="UTF-8") { ; ?>
				<!-- charset warning -->
			...
			<div class="sectionBody">
				...
				<div id="ajax_load_indicator">
					<img src="images/ajax-loader.gif" width="220" height="19" alt="Ajax Loader" class="ajax_loader" />
