<?php  return array (
  ...
  array (
    ...
    'longtitle' => '',
    'description' => '',
    'alias' => '404-stranicza-ne-najdena',
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
    'unpub_date' => 0,
    ...
    <p>Тем не менее, предлагаем Вам найти нужную информацию с помощью меню вверху страницы или же перейти на <a href="[[~[[++site_start]]]]">главную страницу сайта</a></p>
    <div class="clear"></div>
</div>',
    'richtext' => 1,
    'template' => 2,
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1440696184,
    'editedby' => 5,
    'editedon' => 1494598139,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1440696180,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
    ...
    'context_key' => 'web',
    'content_type' => 1,
    'uri' => '404-stranicza-ne-najdena.html',
    'uri_override' => 0,
            ...
            <div class="col-lg-4 col-md-4 col-sm-3 col-xs-12">
                <div class="row">
                    <div class="logo">
                            ...
                            <a href="/"><div class="logo-img"><img src="assets/template/images/otzivi-ginekologi-logo.png" alt="Фото: 404 - Страница не найдена"></div></a>
...
<script type="text/javascript">//<![CDATA[
   ...
   "/template/expressInstall.swf", flashvars, params, attributes);
    ...
    [[!*id:is=`1`:then=`
        [[!+show_banner_on_main:is=`1`:then=`<div class="avb_240" data-alt="404 - Страница не найдена"></div>

`]]
    `:else=`
        [[!+show_banner_on_article:is=`1`:then=`<div class="avb_240" data-alt="404 - Страница не найдена"></div>
...
<article class="main-blog" style="    margin-bottom: 15px;">
        ...
        <span class="main-blog-readmore">Подробнее...</span>
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                            <div class="news main-content title">
                                ...
                                <div class="breadcrumbs"><a href="/">Главная</a> / <span>404 - Страница не найдена</span></div>
                                
                                <div id="seo_content"><div class="textedit">
    <p>Здравствуйте!</p>
    <p>Добро пожаловать на «страницу 404» нашего сайта.</p>
    <p>К сожалению, введенный Вами адрес недоступен. Этому может быть несколько объяснений:</p>
    <ul>
    ...
    <p>Тем не менее, предлагаем Вам найти нужную информацию с помощью меню вверху страницы или же перейти на <a href="https://otzivi-ginekolog.ru/">главную страницу сайта</a></p>
    <div class="clear"></div>
</div></div>
                            </div>
...
<script type="text/javascript">//<![CDATA[
   ...
   "/template/expressInstall.swf", flashvars, params, attributes);
    ...
    '[[$banner_altravita_free_v]]' => '<div class="avb_240" data-alt="404 - Страница не найдена"></div>
...
<article class="main-blog" style="    margin-bottom: 15px;">
    ...
    '[[$BREADCRUMBS]]' => '<div class="breadcrumbs"><a href="/">Главная</a> / <span>404 - Страница не найдена</span></div>',
    '[[pdoMenu?
                                &parents = `0`
                                &level = `1`
                            ]]' => '<ul class=""><li class="first"><a href="blog.html" >Статьи</a></li><li><a href="video.html" >Видео</a></li><li><a href="otzyivyi.html" >Отзывы</a></li><li><a href="obratnaya-svyaz.html" >Обратная связь</a></li><li class="last"><a href="polzovatelskoe-soglashenie.html" >Пользовательское соглашение</a></li></ul>',
